...
- 🐍 Python API reusing the battle-tested CADDY trackers (serverless-ready)
...
1. Enable **Pages** → deploy from `caddyweb/` (or a branch).
...
├── trackers/               # the 4 CADDY job engines (copied from the CLI)

/**
 * ui.js — Templates + rendering + routing for CADDY Jobs.
 */
  ...
  <div class="modal-overlay" id="modalOverlay">
    <div class="modal" role="dialog" aria-modal="true">
      ...
      <div class="modal-body">
        ...
        <p class="modal-source">CADDY Jobs aggregates listings — always verify and apply on the original site.</p>
      </div>
    </div>
  </div>`;
...
function renderAbout() {
  ...
  app.innerHTML = `
    <div class="about-hero">
      <h1>How <span class="grad" style="background:linear-gradient(120deg,var(--primary),var(--accent));-webkit-background-clip:text;background-clip:text;color:transparent">CADDY Jobs</span> works</h1>
    ...
    <div class="about-body">
      ...
      <h2>🧠 The story</h2>
      <p>CADDY started as a hacker-style terminal chatbot for job hunting. This web app is the productized version: the same search engines that powered the terminal, wrapped in a modern interface you can host for free and share with anyone.</p>
      ...
      <h2>🛡️ Privacy</h2>
      <p>Saved jobs live in <b>your browser</b> (localStorage). CADDY Jobs has no database, no accounts, and no tracking — every search goes straight to the job sources.</p>

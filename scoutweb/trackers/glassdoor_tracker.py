#!/usr/bin/env python3
"""
glassdoor_tracker.py - Glassdoor job tracker for SCOUT (no API key required).

Glassdoor is protected by an aggressive bot-wall (Cloudflare/PerimeterX) that
blocks direct requests with 403. SCOUT bypasses it using the free r.jina.ai
...
class GlassdoorJobTracker:
    ...
    def search_jobs(self, keywords: str, location: str = "", limit: int = 10) -> List[Dict]:
        """Search Glassdoor. Returns a list of jobs in SCOUT's shared format."""
        self.last_error = None
